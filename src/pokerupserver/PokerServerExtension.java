...
import pokerupserver.zone.TexassPokerZoneExtension;
...
//    	System.out.print("Poker Server Extension : "+zone.getName());
    	if(zone.getAppKey().equals(TEXASS_APP_KEY) || zone.getAppKey().equals(TEXASS_APP_KEY_LOCAL) || zone.getAppKey().equals(TAXESS_POKERUP)|| zone.getAppKey().equals(TAXESS_POKERUP_LIVE)){

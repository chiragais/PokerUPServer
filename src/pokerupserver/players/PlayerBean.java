package pokerupserver.players;

import java.util.ArrayList;
import java.util.List;

import pokerupserver.cards.Card;
import pokerupserver.cards.PlayerCards;
import pokerupserver.utils.GameConstants.HAND_RANK;
...
//	private boolean isActivePlayer = true;
	...
	public void setCards(Card card1, Card card2, Card waCard) {
		...
		this.waCard = waCard;
//		LogUtils.Log(playerName +" >> Card 1: "+ card1.getCardName()+" >> Card 2: "+ card2.getCardName()+" >> WA Card : " + waCard.getCardName());
	}

...
public interface GameConstants {
	...
	String REQUEST_FOR_RE_BUY = 16 + RESPONSE_DATA_SEPRATOR;
	String RESPONSE_FOR_RE_BUY_STATUS = 17 + RESPONSE_DATA_SEPRATOR;
	String RESPONSE_FOR_BREAK_STATUS = 18 + RESPONSE_DATA_SEPRATOR;
	String RESPONSE_FOR_CHAT = 19  + RESPONSE_DATA_SEPRATOR;
	
	String TAG_GAME_TYPE = "Game_Type";
	int GAME_TYPE_REGULAR = 0;
	int GAME_TYPE_TOURNAMENT_SIT_N_GO = 1;
	int GAME_TYPE_TOURNAMENT_REGULAR = 2;
	...
	String TAG_CURRENT_ROUND = "Current_Round";


	int TOURNAMENT_SNG_BLIND_LEVEL_TIMER = 60 * 1;
	int TOURNAMENT_REGULAR_LEVEL_TIMER = 60 * 1;
...
//	String TAXESS_POKERUP = "6458abad-9ce4-4477-b";
	String TAXESS_POKERUP = "4c09f09e-7a00-45c7-a";
}

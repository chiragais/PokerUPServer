...
import pokerup.players.Winner;
import pokerup.players.WinnerManager;
	...
	private TurnManager addCurrentActionToTurnManager(String userName,
		...
		if (currentPlayer != null) {
			...
			System.out.println("Turn Manager # User: "
					...
					+ " # Bet: " + betAmount + " # Round: "
					+ currentRoundManger.getRound() + " # Total Records : "+ currentRoundManger.getAllTurnRecords().size() +" # Total Bet : "+ currentRoundManger.getTotalRoundBetAmount());
		}
		return turnManager;
	}
